...
/*#__PURE__*/
function () {
  function Difference(oldOficcer, newOfficer, items) {
  ...
  _createClass(Difference, [{
    ...
    key: "hideItems",
    value: function hideItems(itmes) {
      itmes.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function decorizeSlides() {
      ...
      this.slides.forEach(function (slides) {
        slides.classList.remove(_this.activeClass);

        if (_this.animate) {
          slides.querySelector('.card__title').style.opacity = '0.4';
          slides.querySelector('.card__controls-arrow').style.opacity = '0.4';
        }
      });
